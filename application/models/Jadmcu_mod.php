<?php 
	 ...
	 * 
	 */
	class Jadmcu_mod extends CI_Model
	{
		...
		function datajadwal(){
			return $this->db->query("SELECT * FROM jadwal INNER JOIN pelamar ON jadwal.id_pelamar = pelamar.id_pel INNER JOIN sp ON jadwal.no_sp = sp.no_sp INNER JOIN wo ON sp.no_wo = wo.no_wo INNER JOIN lokasi ON wo.idlokasi = lokasi.idlokasi WHERE jadwal.kategori = 'MCU'");
		}
