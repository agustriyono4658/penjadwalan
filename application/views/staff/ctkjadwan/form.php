			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-body">
						...
						<?php echo form_open('staff/ctkjadwan/cetak') ?>
						...
						<div class="card mb-2">
							...
							<div class="form-group">
								<label for="price">Pewawancara*</label>
								<select name="id_wan" class="form-control select2" aria-describedby="sizing-addon2">
        							
          							<option value="">Pilih</option>
          							<?php 
          								foreach ($datapewawancara as $key) {
          							?>
          								<option value="<?php echo $key->id_wan;?>"><?php echo $key->namawan;?></option>
          							<?php
          								}
          							?>
