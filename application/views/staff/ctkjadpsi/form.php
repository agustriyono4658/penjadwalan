			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<?php echo form_open('staff/ctkjadpsi/cetak') ?>
						...
						<div class="card mb-2">
							...
							<div class="form-group">
								<label for="price">Tanggal Psikotes*</label>
								<input class="form-control" type="date" name="tglwan"  placeholder="Tanggal Wawancara"/>
							</div>
							<div class="form-group">
								<label for="price">Tempat Psikotes*</label>
								<select name="kdtmpt" class="form-control select2" aria-describedby="sizing-addon2">
        							<option value="">Pilih</option>
          							<?php 
          								foreach ($data_tempate_test as $key) {
          							?>
          								<option value="<?php echo $key->kdtmpt;?>"><?php echo $key->nmtmpt;?></option>
          							<?php
          								}
          							?>
