<?php
	$dataundangan = $this->db->query("SELECT * FROM undpsikotes INNER JOIN jadwal ON undpsikotes.no_jdwl = jadwal.no_jdwl INNER JOIN pelamar ON jadwal.id_pelamar = pelamar.id_pel INNER JOIN sp ON jadwal.no_sp = sp.no_sp INNER JOIN wo ON sp.no_wo = wo.no_wo INNER JOIN lokasi ON wo.idlokasi = lokasi.idlokasi INNER JOIN tmpttest ON undpsikotes.kdtmpt = tmpttest.kdtmpt WHERE undpsikotes.no_undpsi = '$no_undangan'")->row();
?>
<!DOCTYPE html>
<html>
<head>
	...
	<p>
		<table width="100%">
            <tr>
                ...
                <td width="3%">:</td>
                <td><?php echo $dataundangan->no_undpsi;?></td>
            </tr> 
            <tr>
                <td width="5%"><b>Hal</b></td>
                <td width="3%">:</td>
                <td>Undangan Psikotest</td>
            </tr>      
        </table>
        <br>
        ...
        Dengan hormat.
        <br><br>
        Terkait dengan lamaran anda untuk posisi <b><?php echo $dataundangan->posisiminat;?></b>, Kami menjadwalkan anda untuk mengikuti psikotest pada :<br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tanggal : <?php echo $dataundangan->tgl_jdwl;?><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jam : 10.00 WIB<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Alamat : <?php echo $dataundangan->nmlokasi;?><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tempat : <?php echo $dataundangan->nmtmpt;?><br><br>
