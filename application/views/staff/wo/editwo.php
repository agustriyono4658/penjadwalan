...
<body id="page-top" onload="detailwo()">
	...
	<div id="wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<?php echo form_open('staff/workorder/update') ?>
							...
							<div class="form-group">
								...
								<input class="form-control" type="date" value="<?php echo $data_wo->tgl_wo;?>" name="tglwo" id="tglwo" placeholder="Nama Klien" required="required" />
							</div>
							<div class="form-group">
								...
								<select name="klien" class="form-control select2" aria-describedby="sizing-addon2">
        							<?php
          							...
          							?>
          							<option <?php if($data_wo->id_klien == $klien->id_klien) echo "selected"; ?> value="<?php echo $klien->id_klien; ?>">
							...
							<div class="form-group">
								...
								<select name="asalkota" class="form-control select2" aria-describedby="sizing-addon2">
        							<?php
          							...
          							?>
          							<option <?php if($data_wo->idlokasi == $kota->idlokasi) echo "selected"; ?> value="<?php echo $kota->idlokasi; ?>">
        ...
        <script type="text/javascript">
        	...
        	function detailwo(){
        		var kode_wo = "<?php echo $data_wo->no_wo;?>";
